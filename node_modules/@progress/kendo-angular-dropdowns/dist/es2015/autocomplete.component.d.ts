...
export declare class AutoCompleteComponent implements ControlValueAccessor, OnDestroy, OnChanges, FilterableDropDownComponentBase {
    ...
    constructor(localization: LocalizationService, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, _zone: NgZone, cdr: ChangeDetectorRef, renderer: Renderer2, wrapper: ElementRef);
    ngOnInit(): void;
    ngOnDestroy(): void;
    ngOnChanges(changes: {
