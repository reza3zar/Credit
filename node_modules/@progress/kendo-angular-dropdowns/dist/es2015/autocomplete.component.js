...
export class AutoCompleteComponent {
    constructor(localization, popupService, selectionService, navigationService, _zone, cdr, renderer, wrapper) {
    ...
    set data(data) {
        ...
        if (this.isOpen && this.filterable) {
            this.selectionService.focused = this.data && this.data.length ? 0 : -1;
        }
