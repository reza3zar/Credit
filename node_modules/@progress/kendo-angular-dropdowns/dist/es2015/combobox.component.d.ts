...
export declare class ComboBoxComponent implements ControlValueAccessor, OnDestroy, OnChanges, FilterableDropDownComponentBase {
    ...
    private direction;
    constructor(localization: LocalizationService, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, _zone: NgZone, cdr: ChangeDetectorRef, renderer: Renderer2, wrapper: ElementRef, touchEnabled: boolean);
    ngOnInit(): void;
