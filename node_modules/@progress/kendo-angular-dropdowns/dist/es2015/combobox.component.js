...
export class ComboBoxComponent {
    constructor(localization, popupService, selectionService, navigationService, _zone, cdr, renderer, wrapper, touchEnabled) {
    ...
    set data(data) {
        ...
        if (this._filtering) {
            if (this.text.length > 0) {
                ...
                if (this.selectionService.focused === -1 && data.length) {
