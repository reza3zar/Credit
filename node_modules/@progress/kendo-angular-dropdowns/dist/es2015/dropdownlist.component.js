...
export class DropDownListComponent {
    ...
    subscribeEvents() {
        ...
        this.selectionSubscription.add(merge(this.selectionService.onSelect.pipe(filter(_ => !this.isOpen)), this.selectionService.onChange).pipe(map(this.itemFromEvent.bind(this)), tap(_ => this.togglePopup(false)))
            .subscribe(({ dataItem, index, value: newValue }) => {
            const isIndexSelected = isPresent(index) && !this.selectionService.isSelected(index);
            if (isIndexSelected) {
    ...
    itemFromEvent(event) {
        ...
        const dataItem = isPresent(this.data[index]) ? this.data[index] : this.currentOrDefault();
