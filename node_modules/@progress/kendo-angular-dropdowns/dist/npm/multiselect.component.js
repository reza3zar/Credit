...
var MultiSelectComponent = /** @class */ (function () {
    ...
    MultiSelectComponent.prototype.setState = function (value) {
        ...
        if (this.isOpen && this.selectionService.focused === undefined) {
            this.selectionService.focused = this.data.length ? 0 : this.allowCustom ? -1 : undefined;
        }
        if (!this.text) {
    ...
    MultiSelectComponent.prototype.ngDoCheck = function () {
        ...
        if (this.differ) {
            ...
            if (valueChanges && !this.valueChangeDetected) {
                ...
                var shouldResetState = this.tags.some(function (tag) { return !(isValueCustom_1(tag) || isValueSelected_1(tag)); });
                if (shouldResetState) {
                    this.setState(this.value);
                }
            }
