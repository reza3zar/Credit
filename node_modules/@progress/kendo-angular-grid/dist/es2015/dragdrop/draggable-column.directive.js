...
export class DraggableColumnDirective {
    ...
    ngOnInit() {
        this.subscriptions.add(this.zone.runOutsideAngular(() => this.draggable.kendo.press.pipe(filter(_ => this.enabled), filter(({ originalEvent: { target } }) => skipButtons(target)), tap((e) => {
