import { Component, ElementRef, EventEmitter, HostBinding, Input, Output, Renderer2, ViewChild, forwardRef, isDevMode, NgZone, ChangeDetectorRef } from '@angular/core';
import { Keys } from '../common/enums';
import { anyChanged } from '../common/changes';
import { areSame, hasObservers } from '../common/utils';
...
import { guid, isUntouched } from '../common/dom-utils';
...
var NumericTextBoxComponent = /** @class */ (function () {
    function NumericTextBoxComponent(intl, renderer, localizationService, ngZone, changeDetector, hostElement) {
        var _this = this;
        this.intl = intl;
