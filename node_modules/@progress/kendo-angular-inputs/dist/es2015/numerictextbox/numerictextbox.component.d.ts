import { ElementRef, EventEmitter, OnChanges, OnDestroy, Renderer2, NgZone, ChangeDetectorRef } from '@angular/core';
...
export declare class NumericTextBoxComponent implements ControlValueAccessor, OnChanges, OnDestroy {
    ...
    constructor(intl: IntlService, renderer: Renderer2, localizationService: LocalizationService, ngZone: NgZone, changeDetector: ChangeDetectorRef, hostElement: ElementRef);
    ngOnInit(): void;
    /**
     * @hidden
     */
