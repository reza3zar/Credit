import { AfterViewInit, Renderer2, ElementRef, EventEmitter, OnChanges, OnDestroy, NgZone } from '@angular/core';
...
export declare class SliderComponent implements AfterViewInit, ControlValueAccessor, OnChanges, OnDestroy {
    ...
    constructor(localizationService: LocalizationService, renderer: Renderer2, ngZone: NgZone, hostElement: ElementRef);
    ngOnInit(): void;
    /**
     * Focuses the Slider.
     *
