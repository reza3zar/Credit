...
@Component({
  selector: 'app-formal-letter-details',
  templateUrl: './formal-letter-details.component.html',
  styleUrls: ['./formal-letter-details.component.css']
})
export class FormalLetterDetailsComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.creditServiceSubscriber=this.service.getletterById(this.letterId).subscribe(result=>{
